<template>
  <div class="svg-sprite">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <symbol id="email" viewBox="0 0 37.831 26.685">
      ...
      <symbol id="insta" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.741 32.742">
        <g id="组件_5_1" data-name="组件 5 1" transform="translate(-695.512 -3799.468)">
          <g id="路径_11" data-name="路径 11">
            <path id="Path_14" data-name="Path 14" d="M704.607,3799.468h14.551a9.1,9.1,0,0,1,9.095,9.095v14.551a9.1,9.1,0,0,1-9.095,9.1H704.607a9.1,9.1,0,0,1-9.095-9.1v-14.551A9.1,9.1,0,0,1,704.607,3799.468Z" fill="none"/>
            <path id="Path_15" data-name="Path 15" d="M704.607,3802.255a6.316,6.316,0,0,0-6.309,6.308v14.552a6.316,6.316,0,0,0,6.309,6.308h14.551a6.316,6.316,0,0,0,6.309-6.308v-14.552a6.316,6.316,0,0,0-6.309-6.308H704.607m0-2.787h14.551a9.1,9.1,0,0,1,9.095,9.095v14.552a9.1,9.1,0,0,1-9.095,9.095H704.607a9.1,9.1,0,0,1-9.095-9.095v-14.552A9.1,9.1,0,0,1,704.607,3799.468Z" fill="#afafaf"/>
          </g>
          ...
          <circle id="椭圆_3" data-name="椭圆 3" cx="2.438" cy="2.438" r="2.438" transform="translate(718.5 3804.345)" fill="#afafaf"/>
        </g>
      </symbol>
      <symbol id="phone" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.335 31.748">
